...
class SecurityHeaders
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        if (!app()->environment('testing')) {
            ...
            $response->headers->set('Content-Security-Policy', "script-src 'self' 'unsafe-inline'; frame-src 'self' platform.twitter.com plausible.io utteranc.es github.com *.youtube.com *.vimeo.com; object-src 'none';");
