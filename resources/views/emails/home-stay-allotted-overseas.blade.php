...
<html lang="en">
	...
	<body>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="650" align="center">
			<tbody>
				<tr>
					<td style="color:#FF8000; font-size: 14px; font-family: arial; padding-top: 20px; padding-bottom: 10px; font-weight: 600">Host Details:</td>
				</tr>					
			</tbody>
		</table>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="650" align="center" style="border-top: 1px solid #D6D4D4; border-left: 1px solid #D6D4D4">
			<tbody>
				<tr>
					...
					<td width="70%" style="color:000; font-size: 14px; font-family: arial; padding:5px;font-weight: 400; border-right: 1px solid #D6D4D4; border-bottom: 1px solid #D6D4D4;">{{ $requestDetails->host_name }}</td>
				</tr>
				<tr>
					...
					<td width="70%" style="color:000; font-size: 14px; font-family: arial; padding:5px;font-weight: 400; border-right: 1px solid #D6D4D4; border-bottom: 1px solid #D6D4D4;">{{ $requestDetails->host_email }}</td>
				</tr>
				<tr>
					...
					<td width="70%" style="color:000; font-size: 14px; font-family: arial; padding:5px;font-weight: 400; border-right: 1px solid #D6D4D4; border-bottom: 1px solid #D6D4D4;">{{ $requestDetails->host_mobile }}</td>
				</tr>
				<tr>
					...
					<td width="70%" style="color:000; font-size: 14px; font-family: arial; padding:5px;font-weight: 400; border-right: 1px solid #D6D4D4; border-bottom: 1px solid #D6D4D4;">{{ $requestDetails->host_address }}</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="70%" style="color:000; font-size: 14px; font-family: arial; padding:5px;font-weight: 400; border-right: 1px solid #D6D4D4; border-bottom: 1px solid #D6D4D4;">{{ $requestDetails->airport_distance }}</td>
				</tr>
				@if($requestDetails->map_link!='')
				<tr>
					<td width="30%" style="color:000; font-size: 14px; font-family: arial; padding:5px;font-weight: 600; border-right: 1px solid #D6D4D4; border-bottom: 1px solid #D6D4D4;">Map link:</td>
					<td width="70%" style="color:000; font-size: 14px; font-family: arial; padding:5px;font-weight: 400; border-right: 1px solid #D6D4D4; border-bottom: 1px solid #D6D4D4;">{{ $requestDetails->map_link }}</td>
				</tr>
				@endif
				<tr>
					<td width="30%" style="color:000; font-size: 14px; font-family: arial; padding:5px;font-weight: 600; border-right: 1px solid #D6D4D4; border-bottom: 1px solid #D6D4D4;">Food Habit:</td>
					<td width="70%" style="color:000; font-size: 14px; font-family: arial; padding:5px;font-weight: 400; border-right: 1px solid #D6D4D4; border-bottom: 1px solid #D6D4D4;">{{ $requestDetails->food_habit }}</td>
				</tr>
				@if($requestDetails->vehicle!='')
				<tr>
					<td width="30%" style="color:000; font-size: 14px; font-family: arial; padding:5px;font-weight: 600; border-right: 1px solid #D6D4D4; border-bottom: 1px solid #D6D4D4;">Vehicle:</td>
					<td width="70%" style="color:000; font-size: 14px; font-family: arial; padding:5px;font-weight: 400; border-right: 1px solid #D6D4D4; border-bottom: 1px solid #D6D4D4;">{{ $requestDetails->vehicle }}</td>
				</tr>
				@endif
				@if($requestDetails->vehicle_number!='')
				<tr>
					<td width="30%" style="color:000; font-size: 14px; font-family: arial; padding:5px;font-weight: 600; border-right: 1px solid #D6D4D4; border-bottom: 1px solid #D6D4D4;">Vehicle Number:</td>
					<td width="70%" style="color:000; font-size: 14px; font-family: arial; padding:5px;font-weight: 400; border-right: 1px solid #D6D4D4; border-bottom: 1px solid #D6D4D4;">{{ $requestDetails->vehicle_number }}</td>
				</tr>
				@endif
			</tbody>
		</table>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="650" align="center">
			<tbody>
				<tr>
					<td style="color:#FF8000; font-size: 14px; font-family: arial; padding-top: 20px; padding-bottom: 10px; font-weight: 600">Delegate Details: </td>
				</tr>					
			</tbody>
		</table>
