	...
	<body>
				...
				<tr>
					...
					<td style="background: #0048BA; padding-left: 15px;padding-top: 10px; padding-bottom: 10px">
						<table>
							...
							<tr>
								<td style="font-family: arial; font-size: 14px; font-weight: normal; color: #fff;">Invoiced on {{ date('d M, Y h:i A',strtotime($order->created_at)) }} by {{ $order->created_by_name }} </td>
							</tr>
						</table>
					</td>
				</tr>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="650" align="center">
			<tbody>
				...
				<tr>
					<td style="color:#000; font-size: 14px; font-family: arial; padding-top: 10px; padding-bottom: 10px; font-weight: normal; line-height:20px;">A Invoice has been generated against your order.</strong></td>
				</tr>		
				<tr>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="650" align="center">
			<tbody>
				<tr>
					<td style="color:#FF8000; font-size: 16px; font-family: arial; padding-top: 10px; padding-bottom: 10px; font-weight: 600">Invoice Details</td>
				</tr>
				<tr>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="650" align="center">
			<tbody>
				<tr>
					<td style="height: 15px;">Attached is the Invoice for you sales order.</td>
				</tr>
			</tbody>
		</table>
		<!-- content Area End -->
