	...
	<body>
			...
			<tbody>
				<tr>
					...
					<td style="background: #0048BA; padding-left: 15px;padding-top: 10px; padding-bottom: 10px">
						<table>
							<tr>
								<td style="font-family: arial; font-size: 32px; font-weight: 700; color: #fff;">Purchase Order Received</td>
							</tr>
							<tr>
								<td style="font-family: arial; font-size:18px; font-weight: normal; color: #fff;">Purchase Order #: {{ $order->order_number }} </td>
							</tr>
							<tr>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="650" align="center">
			<tbody>
				...
				<tr>
					<td style="color:#000; font-size: 14px; font-family: arial; padding-top: 10px; padding-bottom: 10px; font-weight: normal; line-height:20px;">An purchase order has been received for <strong>{{ $user->name.' '.$user->last_name }}</strong></td>
				</tr>		
				<tr>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="650" align="center">
			<tbody>
				<tr>
					<td style="color:#FF8000; font-size: 16px; font-family: arial; padding-top: 10px; padding-bottom: 10px; font-weight: 600">Purchase Order Details</td>
				</tr>
				<tr>
