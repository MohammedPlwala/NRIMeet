...
$("#billing_country").on("change", function () {
    ...
    if ($.isArray(selectedStates)) {
        ...
        statesSelectHTML += "</option>";
        if (countryStateSettings[val]) {
            if (countryStateSettings[val].state && !countryStateSettings[val].state.hidden) {
                $("#field_billing_state").html(statesSelectHTML);
            } else {
                $("#field_billing_state").html(
                    statesInputHTML
                );
            }
        } else {
            if (
                countryStateSettings[val] === undefined &&
    ...
    if (countryStateSettings[val] && countryStateSettings[val].state && countryStateSettings[val].state.label) {
        $("#billing_state_label").html(countryStateSettings[val].state.label);
    } else {
