...
@section('content')
    ...
    <form role="form" method="post" enctype="multipart/form-data" action="{{ url('admin/bookings/update-booking/'.$booking->id) }}">
        @csrf
        <div class="nk-block">
                        ...
                        <div class="sp-plan-info card-inner">
                                ...
                                <div class="col-lg-8">
                                    <x-inputs.select for="guest" icon="mail" required="true" class=""
                                        ...
                                        @forelse($guests as $key => $guest)
                                            <option 
                                            @if($booking->user_id == $guest->id) selected @endif
                                ...
                                <div class="col-lg-8">
                                    <x-inputs.select for="hotel" icon="mail" required="true" class=""
                                        ...
                                        @forelse($hotels as $key => $hotel)
                                            <option 
                                            @if($booking->hotel_id == $hotel->id) selected @endif
                            ...
                            <div class="row g-3 align-center">
                                ...
                                <div class="col-lg-8">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <x-inputs.text value="{{ date('m/d/Y',strtotime($booking->check_in_date)) }}" for="checkin_date" class="date-picker checkDate"
                                                icon="calender-date-fill" required="true" placeholder="Date of birth"
                                                name="checkin_date" />
                                        </div>
                                        <div class="col-lg-6">
                                            <x-inputs.text value="{{ date('m/d/Y',strtotime($booking->check_out_date)) }}" for="checkout_date" class="date-picker checkDate"
                                                icon="calender-date-fill" required="true" placeholder="Date of birth"
                                                name="checkout_date" />
                                        </div>
                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <x-inputs.select for="room_one_adult" icon="mail" required="true"
                                                    ...
                                                    <option 
                                                    @if($bookingRooms[0]['adults'] == 0) selected @endif
                                                    value="0">0</option>
                                                    <option 
                                                    @if($bookingRooms[0]['adults'] == 1) selected @endif
                                                    value="1">1</option>
                                                    <option 
                                                    @if($bookingRooms[0]['adults'] == 2) selected @endif
                                                    value="2">2</option>
                                                    <option 
                                                    @if($bookingRooms[0]['adults'] == 3) selected @endif
                                                    value="3">3</option>
                                            ...
                                            <td>
                                                <x-inputs.select for="room_one_child" icon="mail" required="true"
                                                    ...
                                                    <option 
                                                    @if($bookingRooms[0]['childs'] == 0) selected @endif
                                                    value="0">0</option>
                                                    <option 
                                                    @if($bookingRooms[0]['childs'] == 1) selected @endif
                                                    value="1">1</option>
                                            ...
                                            <td>
                                                <select id="room_one_extraBed" icon="mail" required="true"
                                                    ...
                                                    <option 
                                                    @if($bookingRooms[0]['extra_bed'] == 0) selected @endif
                                                    value="0">No</option>
                                                    <option 
                                                    @if($bookingRooms[0]['extra_bed'] == 1) selected @endif
                                                    value="1">Yes</option>
                                            ...
                                            <td class="text-right">
                                                <input type="hidden" id="room_one_price_input" name="room_one_price" value="{{ $bookingRooms[0]['amount'] }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <x-inputs.select for="room_two_adult" icon="mail" required="true"
                                                    ...
                                                    <option 
                                                    @if(isset($bookingRooms[1]) && $bookingRooms[1]['adults'] == 0) selected @endif
                                                    value="0">0</option>
                                                    <option 
                                                    @if(isset($bookingRooms[1]) && $bookingRooms[1]['adults'] == 1) selected @endif
                                                    value="1">1</option>
                                                    <option 
                                                    @if(isset($bookingRooms[1]) && $bookingRooms[1]['adults'] == 2) selected @endif
                                                    value="2">2</option>
                                                    <option 
                                                    @if(isset($bookingRooms[1]) && $bookingRooms[1]['adults'] == 3) selected @endif
                                                    value="3">3</option>
                                            ...
                                            <td>
                                                <x-inputs.select for="room_two_child" icon="mail" required="true"
                                                    ...
                                                    <option 
                                                    @if(isset($bookingRooms[1]) && $bookingRooms[1]['childs'] == 0) selected @endif
                                                    value="0">0</option>
                                                    <option 
                                                    @if(isset($bookingRooms[1]) && $bookingRooms[1]['childs'] == 1) selected @endif
                                                    value="1">1</option>
                                            ...
                                            <td>
                                                ...
                                                <option 
                                                @if(isset($bookingRooms[1]) && $bookingRooms[1]['extra_bed'] == 0) selected @endif
                                                value="0">No</option>
                                                <option 
                                                @if(isset($bookingRooms[1]) && $bookingRooms[1]['extra_bed'] == 1) selected @endif
                                                value="1">Yes</option>

                                            </select>
                                            </td>
                                            <td>
                                                ₹<span id="room_two_rate">{{ isset($bookingRooms[1]) ? $bookingRooms[1]['rate'] : 0 }}</span> / Night<br />
                                                <small>Tax Inclusive</small>

                                            </td>
                                            <td class="text-right">
                                                <input type="hidden" id="room_two_price_input" name="room_two_price" value="{{ isset($bookingRooms[1]) ? $bookingRooms[1]['amount'] : 0 }}">
                                                <input type="hidden" id="room_two_data" name="room_two_data">
                                                ₹<span id="room_two_price">{{ isset($bookingRooms[1]) ? $bookingRooms[1]['amount'] : 0 }}</span>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-9">
                        <div class="row g-3 align-center">
                            ...
                            <div class="col-lg-7">
                                <x-inputs.textarea value="{{ isset($booking) ? $booking->special_request : '' }}" for="special_request" class="" icon="notes-alt" placeholder="Special Request" name="special_request" />
                            </div>
                        </div>
            ...
            <div class="card card-bordered sp-plan">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row g-3 align-center">
                            ...
                            <div class="col-lg-7">
                                <x-inputs.select for="status" icon="mail" required="true" class=""
                                    ...
                                    <option 
                                    @if($booking->booking_status == 'Booking Received') selected @endif
                                    value="Booking Received">Booking Received</option>
                                    <option 
                                    @if($booking->booking_status == 'Payment Completed') selected @endif
                                    value="Payment Completed">Payment Completed</option>
                                    <option 
                                    @if($booking->booking_status == 'Booking Shared') selected @endif
                                    value="Booking Shared">Booking Shared</option>
                                    <option 
                                    @if($booking->booking_status == 'Confirmation Recevied') selected @endif
                                    value="Confirmation Recevied">Confirmation Recevied</option>
                                    <option 
                                    @if($booking->booking_status == 'Cancellation Requested') selected @endif
                                    value="Cancellation Requested">Cancellation Requested</option>
                                    <option 
                                    @if($booking->booking_status == 'Cancellation Approved') selected @endif
                                    value="Cancellation Approved">Cancellation Approved</option>
                                    <option 
                                    @if($booking->booking_status == 'Refund Requested') selected @endif
                                    value="Refund Requested">Refund Requested</option>
                                    <option 
                                    @if($booking->booking_status == 'Refund Approved') selected @endif
                                    value="Refund Approved">Refund Approved</option>
                                    <option 
                                    @if($booking->booking_status == 'Refund Issued') selected @endif
                        ...
                        <div class="row g-3 align-center">
                            <div class="col-lg-5">
                                <x-inputs.verticalFormLabel label="Confirmation Number" for="confirmation_number" suggestion="" />
                            </div>
                            <div class="col-lg-7">
                                <x-inputs.text value="{{ isset($booking) ? $booking->confirmation_number : '' }}" for="confirmation_number" class="" icon="building-fill" placeholder="Hotel Name" name="confirmation_number" />
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-center">
                            ...
                            <div class="col-lg-7">
                                <x-inputs.text value="{{ isset($booking) ? $booking->utr_number : '' }}" for="utr_number" class="" icon="building-fill" placeholder="Hotel Name" name="utr_number" />
                            </div>
                        </div>

                        <div class="row g-3 align-center">
                            <div class="col-lg-5">
                                <x-inputs.verticalFormLabel label="Settlement Date" for="settlement_date" suggestion="" />
                            </div>
                            <div class="col-lg-7">
                                <x-inputs.text value="{{ isset($booking) ? $booking->settlement_date : '' }}" for="settlement_date" class="date-picker" icon="building-fill" placeholder="Hotel Name" name="settlement_date" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                for (let index = 0; index < value; index++) {
                    html += `
                            <div class="row g-3 align-center">
                                ...
                                <div class="col-lg-8">
                                    <x-inputs.text value="" for="rooms_${room}_${firstName}_${index}" name="rooms[${room}][${firstName}][${index}]" placeholder="First Name" />
                                </div>
                            </div>
                        `
                }
