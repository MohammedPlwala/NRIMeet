...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between g-3">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title"><a href="javascript:history.back()" class="pt-3"><em class="icon ni ni-chevron-left back-icon"></em> </a>  Visiter / <strong class="text-primary small">{{ $visiter->name }}</strong></h3>
        </div>
    </div>
</div><!-- .nk-block-head -->
<div class="nk-block">
