                            ...
                            <div class="row g-3 align-center">
                                ...
                                <div class="col-lg-7">
                                    <x-inputs.text value="" for="date" class="date-picker"
                                        icon="calender-date-fill" placeholder="Date" name="date" required="true" />
                                    @if ($errors->has('date'))
                            ...
                            <div class="row g-3 align-center">
                                ...
                                <div class="col-lg-7">
                                    <x-inputs.text value="" for="ContactNumber" icon="call"
                                        placeholder="Contact Number" name="ContactNumber" required="true" />
                                </div>
                            </div>
                            ...
                            <div class="row g-3 align-center">
                                ...
                                <div class="col-lg-7">
                                    <x-inputs.text value="" for="WhatsappNumber" icon="whatsapp-round"
                                        placeholder="Whatsapp Number" name="WhatsappNumber" required="true" />
                                </div>
                            </div>
                            ...
                            <div class="row g-3 align-center">
                                ...
                                <div class="col-lg-7">
                                    <x-inputs.email value="" for="EmailId" icon="mail-fill"
                                        placeholder="Email Id" name="EmailId" required="true" />
                                </div>
                            </div>
                            ...
                            <div class="row g-3 align-center">
                                ...
                                <div class="col-lg-7">
                                    <x-inputs.select value="" for="subIssue" id="subIssue" icon="send"
                                        placeholder="Sub Issue" name="subIssue" required="true">
                            ...
                            <div class="row g-3 align-center">
                                ...
                                <div class="col-lg-7">
                                    <x-inputs.textarea value="" for="issue" icon="align-left"
                                        placeholder="Detailed issue" name="issue" required="true" />
                            ...
                            <div class="row g-3 align-center">
                                ...
                                <div class="col-lg-7">
                                    <x-inputs.text value="" for="pendingWidth" icon="align-left"
                                        placeholder="Detailed pendingWidth" name="pendingWidth" required="true" />
                                </div>
                            </div>
                            ...
                            <div class="row g-3 align-center">
                                ...
                                <div class="col-lg-7">
                                    <x-inputs.textarea value="" for="remark" icon="align-left"
                                        placeholder="Remark" name="remark" required="true" />
                                </div>
                            </div>
