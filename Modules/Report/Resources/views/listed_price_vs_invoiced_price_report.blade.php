...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Listed Price vs Invoiced Price</h3>
        ...
        <table class="products-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
            <thead>
                <tr class="nk-tb-item nk-tb-head">
                    ...
                    <th class="nk-tb-col tb-col-mb"><span class="sub-text">Part Name</span></th>
                    <th class="nk-tb-col tb-col-mb"><span class="sub-text">Part Number - SKU</span></th>
                    <th class="nk-tb-col tb-col-mb"><span class="sub-text">Invoiced Price</span></th>
                    <th class="nk-tb-col tb-col-mb"><span class="sub-text">MRP</span></th>
                    <th class="nk-tb-col tb-col-mb"><span class="sub-text">NDP</span></th>
                    <th class="nk-tb-col tb-col-mb"><span class="sub-text">Margin (Invoiced Price-NDP)</span></th>
            ...
            <tbody>
                <tr class="nk-tb-item odd" role="row">
                    ...
                    <td class=" nk-tb-col tb-col-lg">100.00</td>
                    <td class=" nk-tb-col tb-col-lg">100.00</td>
