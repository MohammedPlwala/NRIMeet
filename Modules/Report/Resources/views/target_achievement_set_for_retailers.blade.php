...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Target / Achievement For Buyers</h3>
            <p>{{ $note }}</p>
...
<div class="nk-block table-compact">
    <div class="nk-tb-list is-separate is-medium mb-3">
        <table id="buyer_target" class="products-init nowrap nk-tb-list is-separate table-head-bottom" data-auto-responsive="false">
            <thead>
                <tr class="nk-tb-item nk-tb-head">
                    <th class="nk-tb-col tb-col-mb" rowspan="2"><span class="sub-text">Buyer Name</span></th>
                    ...
                    <th class="nk-tb-col tb-col-mb text-center" colspan="2"><span class="sub-text">Total Order</span></th>
                    <th class="nk-tb-col tb-col-mb text-center" colspan="2"><span class="sub-text">Total Line Items</span></th>
...
<div class="modal fade zoom" tabindex="-1" id="modalFilterorder">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form role="form" id="filterForm" class="mb-0" method="get" action="#">
                @csrf
...
<script type="text/javascript">
    ...
    var dataTable = new APIDataTable({
        tableElem: '#buyer_target',
        pageinationElem: '#table_pagination',
        api: "{{ url('api/v1/report/target-achievement-buyers') }}/"+organizationId,
    ...
    //         '#city'
    //     ];
    //     NioApp.filterTag(items, dataTable['#buyer_target'], '#filter_tag_list');
    // });
