...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Product Category wise Sales</h3>
            ...
            <form role="form" class="mb-0" method="get" action="#">
                ...
                <div class="modal-body modal-body-lg">
                    <div class="gy-3">
                        ...
                        <div class="row g-3 align-center">
                            <div class="col-lg-5">
                                <x-inputs.verticalFormLabel label="Day" for="day" suggestion="Select the day." />
                            </div>
                            <div class="col-lg-7">
                                <x-inputs.select  size="sm" name="day" for="day" placeholder="Day">
                                    <option value="">Select</option>
                                </x-inputs.select>
                            </div>
                        </div>
