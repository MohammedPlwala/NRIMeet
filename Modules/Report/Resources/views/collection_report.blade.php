...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Collection Report</h3>
        ...
        <table class="products-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
            <thead>
                <tr class="nk-tb-item nk-tb-head">
                    ...
                    <th class="nk-tb-col tb-col-mb"><span class="sub-text">Collected By</span></th>
                    <th class="nk-tb-col tb-col-mb"><span class="sub-text">Collected Amount</span></th>
                    <th class="nk-tb-col tb-col-mb"><span class="sub-text">Mode</span></th>
                    <th class="nk-tb-col tb-col-mb"><span class="sub-text">Collection Date</span></th>
