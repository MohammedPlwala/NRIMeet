...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Sales by Sales Person</h3>
        ...
        <table id="sales_SP" class="products-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
            <thead>
                <tr class="nk-tb-item nk-tb-head">
                    <th class="nk-tb-col tb-col-mb"><span class="sub-text">Sales Person</span></th>
                ...
                <div class="modal-footer bg-light">
                    <div class="row">
                        <div class="col-lg-12 p-0 text-right">
                            ...
                            <button class="btn btn-danger resetFormFilter" data-dismiss="modal" aria-label="Close">Clear Filter</button>
...
<script type="text/javascript">
    ...
    var dataTable = new APIDataTable({
        ...
        api: "{{ url('api/v1/report/sales-by-sales-person') }}/"+organizationId,
        ...
        filterClearSubmit: '.resetFormFilter',
        // filterClearSubmitCallback: function(){
        //     $('#modalFilterorder').modal('toggle');
        // },
