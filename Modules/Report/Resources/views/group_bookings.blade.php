...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Group Bookings</h3>
                ...
                <div class="toggle-expand-content" data-content="more-options">
                    <ul class="nk-block-tools g-3">
                        ...
                        <li class="nk-block-tools-opt">
                            <a href="{{ url('report/export-group-bookings') }}" class="btn btn-primary"><em class="icon ni ni-download"></em><span>Export</span></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <table id="sales_SP" class="products-init nowrap nk-tb-list is-separate table-head-bottom" data-auto-responsive="false">
                <thead>
                    <tr class="nk-tb-item nk-tb-head">
                        <th class="nk-tb-col tb-col-mb" rowspan="2"><span class="sub-text">Group Name</span></th>
                        ...
                        <th class="nk-tb-col tb-col-mb text-center" colspan="3"><span class="sub-text">Group Booking Status</span></th>
                    </tr>
                    <tr class="nk-tb-item nk-tb-head">
                ...
                <tbody>
                    <tr class="nk-tb-item">
                        <td class="nk-tb-col tb-col-mb">Group Name</td>
