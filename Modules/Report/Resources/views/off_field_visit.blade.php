...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Off-Field Visits</h3>
        ...
        <table id="sales_SP" class="products-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
            <thead>
                <tr class="nk-tb-item nk-tb-head">
                    ...
                    <th class="nk-tb-col tb-col-mb"><span class="sub-text">Plan</span></th>
                ...
                <div class="modal-body modal-body-lg">
                    <div class="gy-3">
                        ...
                        <div class="row g-3 align-center">
                            <div class="col-lg-5">
                                <x-inputs.verticalFormLabel label="Plan" for="plan" suggestion="Select the plan." />
                            </div>
                            <div class="col-7">
                                <x-inputs.select for="plan" size="sm"  name="plan">
                                    <option value=""></option>
                        ...
                        <div class="row g-3 align-center">
                            <div class="col-lg-5">
                                <x-inputs.verticalFormLabel label="Dsp" for="Dsp" suggestion="Select the sales person." />

                            </div>
                            <div class="col-7">
                                <x-inputs.select for="sales_person" size="sm" name="dsp">
                                    <option></option>
...
<script type="text/javascript">
    ...
    var dataTable = new APIDataTable({
        ...
        api: "{{ url('api/v1/report/offfield-visits') }}/"+organizationId,
        ...
        columns: [{
            ...
            },
            {
                data: "plan",
                render: function(row) {
                    if(row.plan == "FULL_DAY_LEAVE" || row.plan == "HALF_DAY_LEAVE"){
                        return row.plan.replaceAll("_", " ");
                    }
                    else {
                        return row.plan;
                    }
