...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Pending Sales Order</h3>
        ...
        <table id="sales_SP" class="products-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
            <thead>
                <tr class="nk-tb-item nk-tb-head">
                    <th class="nk-tb-col tb-col-mb"><span class="sub-text">Order Number</span></th>
...
<script type="text/javascript">
    ...
    var dataTable = new APIDataTable({
        ...
        api: "{{ url('api/v1/report/pending-sales-order') }}/"+organizationId,
