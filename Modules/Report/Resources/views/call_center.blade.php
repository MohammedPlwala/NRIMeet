                ...
                <div class="toggle-expand-content" data-content="more-options">
                    <ul class="nk-block-tools g-3">
                        ...
                        <li class="nk-block-tools-opt">
                            <a href="{{ url('report/export-call-center') }}" class="btn btn-primary"><em class="icon ni ni-download"></em><span>Export</span></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <table id="sales_SP" class="products-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
                <thead>
                    <tr class="nk-tb-item nk-tb-head">
                        ...
                        <th class="nk-tb-col tb-col-mb"><span class="sub-text">PBD Registration No.</span></th>
                ...
                <tbody>
                    <tr class="nk-tb-item">
                        ...
                        <td class="nk-tb-col tb-col-mb">Process</td>
                        <td class="nk-tb-col tb-col-mb">Base</td>
                        <td class="nk-tb-col tb-col-mb">Sheraton Grand Palace Indore</td>
                        <td class="nk-tb-col tb-col-mb"><span class="badge badge-warning">Pending</span></td>
                    ...
                    <tr class="nk-tb-item">
                        ...
                        <td class="nk-tb-col tb-col-mb">Base</td>
                        <td class="nk-tb-col tb-col-mb">Sheraton Grand Palace Indore</td>
                        <td class="nk-tb-col tb-col-mb"><span class="badge badge-success">Success</span></td>
                        <td class="nk-tb-col tb-col-mb">PBD Awardees</td>
                        <td class="nk-tb-col tb-col-mb">Base</td>
                    </tr>
                </tbody>
