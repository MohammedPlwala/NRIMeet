                                ...
                                <div class="sidebar_center">
                                    ...
                                    <div class="shb-booking-your-stay-item shb-clearfix">
                                        ...
                                        <div class="shb-booking-your-stay-item-info">
                                            <h4 class="shb-clearfix"><a href="#">WOW Hotel</a><span> ₹10,800</span>
                                            </h4>
                                            <p class="shb-booking-your-stay-item-info-detail">Premium</p>
                                            <p class="shb-booking-price-expand"><a href="#">1 Night</a><i
                ...
                <div class="guests_info_front_main_div">
                    <form method="POST" id="guests_info_front_form" autocomplete="off">
                        ...
                        <div class="Guests_info_front_box">
                            ...
                            <div class="form-item">
                                <input type="text" maxlength="25" required name="shb_guest_info_detail[1][107][1][First]"
                                    value="" placeholder="First Name">
                            </div>
                            <div class="form-item">
                                <input type="text" maxlength="25" required name="shb_guest_info_detail[1][107][1][Last]"
                        ...
                        <div class="Guests_info_front_box">
                            ...
                            <div class="form-item">
                                <input type="text" maxlength="25" required name="shb_guest_info_detail[1][107][2][First]"
                                    value="" placeholder="First Name">
                            </div>
                            <div class="form-item">
                                <input type="text" maxlength="25" required name="shb_guest_info_detail[1][107][2][Last]"
                                    value="" placeholder="Last Name">
                            </div>
                        </div>
                        <h5>Children</h5>
                        ...
                        <div class="Guests_info_front_box">
                            ...
                            <div class="form-item">
                                <input type="text" maxlength="25" required
                                    name="shb_guest_info_detail[1][108][1][First]" value=""
                                    placeholder="First Name" />
                            </div>
                            <div class="form-item">
                                <input type="text" maxlength="25" required
                                    name="shb_guest_info_detail[1][108][1][Last]" value=""
