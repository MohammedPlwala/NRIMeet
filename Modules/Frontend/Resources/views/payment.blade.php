                ...
                <form>
                    ...
                    <div id="billing_details" class="custom-form">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 md:gap-x-12 md:gap-y-4 gap-2">
                            ...
                            <div class="form-item">
                                <label class="form-label">State <span class="required" title="required">*</span></label>
                                <select name="billing_state" id="billing_state" class="state_select select2-hidden-accessible" autocomplete="address-level1" data-placeholder="Select an option…" data-input-classes="" data-label="State" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="form-item">
                                <label class="form-label">Town / City <span class="required" title="required">*</span></label>
                            ...
                            <div class="form-item">
                                <label class="form-label">Street address <span class="required" title="required">*</span></label>
                                <input type="text" class="input-text " name="billing_address_1" id="billing_address_1" placeholder="House number and street name" value="" autocomplete="address-line1" data-gtm-form-interact-field-id="1" />
                            </div>
                            <div class="form-item">
                            ...
                            <div class="form-item">
                                <label class="form-label">Email Address <span class="required" title="required">*</span></label>
                                <input type="email" class="input-text " name="billing_email" id="billing_email" placeholder="" value="" autocomplete="email username" data-gtm-form-interact-field-id="0">
                            </div>

                            <div class="form-item">
                                <label class="form-label">Alternate Phone <span class="required" title="optional">(optional)</span></label>
                                <input type="text" class="input-text " name="billing_phone2" id="billing_phone2" placeholder="Alternate Phone" value="" />
                            </div>
                            <div class="form-item">
                                <label class="form-label">Alternate Email Address <span class="required" title="optional">(optional)</span></label>
                                <input type="text" class="input-text" name="billing_email2" id="billing_email2" placeholder="Alternate Email Address" value="" />
                            </div>
                        </div>
                    </div>
