    ...
    <div class="lg:basis-1/4 lg:block hidden">
      ...
      <div class="shb-booking-page-sidebar customer_filter">
        ...
        <div class="custom_filter_main_div">
          <form id="search" action="{{ url('/bookings') }}" method="get">
            <div class="custom_filter_innder_div">
              <label for="shb-hotal-name" class="filter_label  mb-2 block">Hotel name</label>
              <input id="s" name="shb-hotal-name" id="shb-hotal-name" type="text" placeholder="Search by Hotel Name"
                value=""
            ...
            <div class="custom_filter_innder_div filter_sortby mb-7">
              ...
              <label for="price_low_to_high"><input type="radio" id="price_low_to_high" onchange="this.form.submit()"
                  name="shb-orderby" value="p1" class="mr-2 mt-1">Price Low to High</label>
              <label for="price_high_to_low"><input type="radio" id="price_high_to_low" onchange="this.form.submit()"
                  name="shb-orderby" value="p2" class="mr-2 mt-1">Price High to Low</label>
            ...
            <div class="flex justify-between content-end">
              <a href="{{ url('/bookings/') }}" class="hotel-search-button_clear self-end">Clear All</a>
              <input type="submit"
          ...
          <div class="booking-form-wrap desktop">
            <form action="{{ url('/search') }}" method="post"
              ...
              <div class="shbdp-cal-wrapper shbdp-clearfix" data-panels="2"
                ...
                <input type="hidden" class="shbdp-checkin" name="date_from" value="{{ \Session::get('date_from') }}"
                  data-from="{{ \Session::get('date_from') }}">
                <input type="hidden" class="shbdp-checkout" name="date_to" value="{{ \Session::get('date_to') }}"
                  data-to="{{ \Session::get('date_to') }}">
              ...
              <div class="shb-guestclass-select-dropdown">
                ...
                <div class="shb-guestclass-select-section shb-clearfix show_filter_2_room"
                  ...
                  <div class="shb-qty-selection shb-clearfix">
                    <button type="button" class="shb-qty-decrease">-</button>
                    <div class="shb-qty-display" id="other-shb-qty-display-107">{{ \Session::get('room_two_adult') }}
                    </div>
                    <button type="button" class="shb-qty-increase">+</button>
                  </div>
                ...
                <div class="shb-guestclass-select-section shb-clearfix show_filter_2_room"
                  ...
                  <div class="shb-qty-selection shb-clearfix">
                    <button type="button" class="shb-qty-decrease">-</button>
                    <div class="shb-qty-display" id="other-shb-qty-display-108">{{ \Session::get('room_two_child') }}
                    </div>
                    <button type="button" class="shb-qty-increase">+</button>
                  </div>
            ...
            <li class="hotal-rooms-item">
              <div class="hotal-rooms" id="hotel-{{ $hotel->id }}">
                <div class="hotal-image">
                  <a>
                    <img src="{{url('/images/WOW-Hotel.jpeg')}}" alt="WOW Hotel" />
                  </a>
                </div>
                      ...
                      <li>
                        <div class="booking-rate-info flex content-center justify-between">
                          ...
                          <div class="search_center">
                            <h3 class="custom_the_per_night"><a href="javascript:void(0)" class="per_night">
                                ₹{{ $room->rate }}<span> / Night</span><span class="tax_inclusive">Tax
                                  Inclusive</span></a></h3>
                          </div>
